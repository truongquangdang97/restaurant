...
<div class="all">
    <h1>Thêm món ăn </h1>
    <form action="/food/create" method="POST" name="create-form">
        <div class="mb-3">
            <label  class="form-label">Food Name</label>
            <input type="text"  class="form-control" name="nameFood">
